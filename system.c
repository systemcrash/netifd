...
static const struct blobmsg_policy tunnel_attrs[__TUNNEL_ATTR_MAX] = {
	...
	[TUNNEL_ATTR_ENCAP_SPORT] = { .name = "encap_sport", .type = BLOBMSG_TYPE_STRING },
	[TUNNEL_ATTR_ENCAP_DPORT] = { .name = "encap_dport", .type = BLOBMSG_TYPE_INT32 },
	[TUNNEL_ATTR_ENCAP_TYPE] = { .name = "encap_type", .type = BLOBMSG_TYPE_STRING },
	[TUNNEL_ATTR_ENCAP_CSUM] = { .name = "encap_csum", .type = BLOBMSG_TYPE_BOOL },
	[TUNNEL_ATTR_ENCAP_CSUM6] = { .name = "encap_csum6", .type = BLOBMSG_TYPE_BOOL },
	[TUNNEL_ATTR_ENCAP_REMCSUM] = { .name = "encap_remcsum", .type = BLOBMSG_TYPE_BOOL },
